...
func handleGRPCServer(ctx context.Context, u *url.URL, dsEndpoints *ds.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		dsServer = dssvr.New(dsEndpoints, nil)
	}
	...
	dspb.RegisterDsServer(srv, dsServer)
